...
function Field({ label, error, children }: { label: string; error?: string; children: ReactNode }) {
	return (
		<label className="block text-left text-[11px] text-white [&_input]:h-9 [&_input]:w-full [&_input]:rounded-[2px] [&_input]:border-0 [&_input]:bg-white [&_input]:px-3 [&_input]:text-[11px] [&_input]:text-[#334155] [&_input]:outline-none [&_input]:placeholder:text-[#64748b] [&_select]:h-9 [&_select]:w-full [&_select]:rounded-[2px] [&_select]:border-0 [&_select]:bg-white [&_select]:px-3 [&_select]:text-[11px] [&_select]:text-[#334155] [&_select]:outline-none [&_textarea]:w-full [&_textarea]:resize-none [&_textarea]:rounded-[2px] [&_textarea]:border-0 [&_textarea]:bg-white [&_textarea]:px-3 [&_textarea]:py-2 [&_textarea]:text-[11px] [&_textarea]:text-[#334155] [&_textarea]:outline-none [&_textarea]:placeholder:text-[#64748b]">
