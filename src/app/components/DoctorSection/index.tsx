...
export default function DoctorSection() {
  return (
    <section id="parents" className="scroll-mt-24 relative overflow-hidden bg-gradient-to-r from-[#426b9d] to-[#79a9e8] px-5 py-20 text-white sm:px-8 lg:px-12 lg:py-24">
      <Image
        src={brandIcon}
        alt=""
        aria-hidden="true"
      ...
      <div className="relative z-10 mx-auto grid max-w-[1180px] items-center gap-12 lg:grid-cols-[1fr_430px] lg:gap-20">
        <div className="max-w-[500px]">
          ...
          <div className="mt-7 flex flex-wrap items-center gap-4">
            ...
            <a href="#team" className="flex items-center gap-3 text-xs font-semibold uppercase text-white">
              <span className="flex h-9 w-9 items-center justify-center rounded-full border-4 border-white/80 bg-[#fffdf9] text-[#426b9d]"><ArrowRight className="h-4 w-4" /></span>
              Meet the team
            </a>
          </div>
        </div>
        ...
        <div className="relative mx-auto w-full max-w-[430px]">
          ...
          <div className="absolute -bottom-4 left-[-48px] max-w-[245px] rounded-[4px] bg-[#5579ad]/95 px-5 py-5 text-center text-xs leading-4 text-white shadow-lg sm:left-[-55px]">
            <span className="mb-2 block text-2xl leading-3">&ldquo;</span>
            We are a caring and compassionate group, and we take pride in delivering quality oral healthcare to children in a safe environment.
          </div>
        </div>
      </div>
    </section>
